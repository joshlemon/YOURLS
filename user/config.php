 ...
 */
 ...
 /*
  ** ClearDB settings - You can get this info from your web host
  */
...
define( 'YOURLS_DB_USER', $db_url["user"] );

/** MySQL database password */
define( 'YOURLS_DB_PASS', $db_url["pass"] );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', substr($db_url["path"], 1) );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', eg. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', $db_url["host"] );
